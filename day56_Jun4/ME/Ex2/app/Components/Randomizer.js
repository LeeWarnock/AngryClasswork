...
var Parent = React.createClass({
	...
	// This will reset the clicks -- and it will be passed  ALL Randomizerren
	resetClick: function(){
			...
			<div className="container">
				...
				<div className="row">
					...
					<div className="jumbotron">
						<h2>All my Randomizerren: A Tale of Reactive Components</h2>
						<p><em>Remember, parents pass Randomizerren their "states". Randomizerren inherit them as "props".</em></p>
						<p>
					...
					<div className="col-md-12">
						...
						<div className="panel panel-default">
							...
							<div className="panel-body text-center">
								...
								{/*Here we'll deploy the Randomizer component. We'll pass it the parent's click counter as a "state"*/}
