...
/***/ function(module, exports, __webpack_require__) {
	...
	// Include Grandhild
	var Child = __webpack_require__(161);
					...
					React.createElement(
						...
						React.createElement(
							...
							React.createElement(
								"i",
								null,
								"A lesson on props, states, parents, and children"
							),
							" "
						)
					),
					...
					React.createElement(
						...
						React.createElement(
							...
							React.createElement(
								"div",
								{ className: "panel-body text-center" },
								React.createElement("img", { src: this.state.img, width: "100%" })
							)
						)
					),
					React.createElement(Child, { dadsAge: this.state.age, dadsFuzzy: this.state.isFuzzy, dadsArtistry: this.state.artistry })
				)
			);
		}
	});
						...
						React.createElement(
							...
							React.createElement(
								...
								React.createElement(
									...
									null,
									"Age: ",
									this.props.dadsAge / 8
								),
								React.createElement(
									"h2",
									null,
									"Fuzziness: ",
									(!this.props.dadsFuzzy).toString()
								),
								React.createElement(
									"h2",
									null,
									"Artistry: ",
									this.props.dadsArtistry / 10
								)
							)
						)
					),
