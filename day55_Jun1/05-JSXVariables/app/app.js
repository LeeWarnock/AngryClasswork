...
var num1 = 1;
var num2 = 2;
var dob = moment("1929-01-01", "YYYY-MM-DD");
	...
	<div className='main-container'>
		...
		<div className="container">
			...
			<div className="jumbotron">
				...
				<h1>The JSX Boss!</h1>
				<h1> I was born on 08/22/1929 </h1>
				<hr />
				<h2>I can do math: {num1 + num2}.</h2>
				<h2>I can generate random numbers: {Math.floor(Math.random() * 10) + 1  }, {Math.floor(Math.random() * 10) + 1  }, {Math.floor(Math.random() * 10) + 1  }.</h2>
